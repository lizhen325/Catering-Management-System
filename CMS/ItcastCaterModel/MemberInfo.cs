...
namespace ItcastCater.Model
{
    ...
    {
        //select MemmberId,MemName,MemMobilePhone,MemType,MemNum,MemGender,MemDiscount,MemMoney,DelFlag,SubTime,MemIntegral,MemEndServerTime,MemBirthdaty from MemmberInfo
